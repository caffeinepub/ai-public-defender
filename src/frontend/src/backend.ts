...
import type { CaseAnalysisInput as _CaseAnalysisInput, ExternalBlob as _ExternalBlob, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async analyzeCase(arg0: CaseAnalysisInput): Promise<CaseAnalysisResult> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeCase(to_candid_CaseAnalysisInput_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async downloadDocument(arg0: string): Promise<string | null> {
        if (this.processError) {
            try {
    ...
    async getFeedback(arg0: FeedbackInput): Promise<FeedbackResponse> {
        if (this.processError) {
            try {
    ...
    async practiceMode(arg0: PracticeModeInput): Promise<PracticeModeResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.practiceMode(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadDocument(arg0: ExternalBlob, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadDocument(await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg0), arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_CaseAnalysisInput_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: CaseAnalysisInput): _CaseAnalysisInput {
...
function to_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        documentContext: value.documentContext ? candid_some(value.documentContext) : candid_none(),
